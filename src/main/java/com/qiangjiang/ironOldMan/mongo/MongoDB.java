//package com.qiangjiang.ironOldMan.mongo;
//
...
//            MongoCredential credential = MongoCredential.createScramSha1Credential("jiangqiang",
//                    "istock", "123456".toCharArray());//toCharArray
...
//            //>
//            MongoDatabase mongoDatabase = mongoClient.getDatabase("istock");
//
//            log("获取数据库成功!");
//            //重复创建会报错
