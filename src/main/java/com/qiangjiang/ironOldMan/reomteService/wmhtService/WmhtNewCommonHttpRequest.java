...
//    private HttpTracing httpTracing;
    ...
    public Optional postJSON(String url, Object param, String bankOrderNo ){
        ...
        String hostName = SystemUtils.sysHostname();
...
//            httpPost.addHeader(HTTP.CONTENT_TYPE, "text/xml");
    ...
    public  Optional postJSON1(String url, String param, String bankOrderNo, String charSet, Class resClass){
        logger.info("银联商务通道请求参数 url [ "+url+" ] bankOrderNo ["+bankOrderNo+"]  reqDdata ["+param+"]");
        System.out.println("银联商务通道请求参数 url [ "+url+" ] bankOrderNo ["+bankOrderNo+"]  reqDdata ["+param+"]");
        long startTime = System.currentTimeMillis();
        ...
        try{
            ...
            if (entity != null) {
                String result = EntityUtils.toString(entity, "UTF-8");
                //  logger.info("url [ "+url+" ] bankOrderNo ["+bankOrderNo+" ] resDdata ["+result+"]");
                logger.info("银联商务通道响应参数"+result);
                System.out.println("银联商务通道响应参数"+result);
